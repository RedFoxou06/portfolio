const projects = [
    ...
    {
        id: 13,
        title: "Psartekbogosse.fr",
        languages: ["HTML", "CSS", "Javascript"],
        type: ["Personnel"],
        software: ["Intellij" , "Git" , "Scene Builder", "Gradle"],
        thumb: "img/psartekbogosse/psartekbogosse.png",
        desc: "Il s'agit d'un site troll que j'ai réalisé pour des amis. /!\\ A ne pas prendre au sérieux, il s'agit d'un site réalisé uniquement à but humoristique.",
        images: ["img/psartekbogosse/psartekbogosse_1.png"],
        github: "https://github.com/RedFoxou06/psartekbogosse",
        link: "http://psartekbogosse.fr"
    }
];
